...
summary: Há um processo de fluxo de trabalho que você pode usar para implantar um cluster ONTAP Select . 
---
...
[role="lead"]
Você pode usar o seguinte fluxo de trabalho para implantar e administrar um cluster ONTAP Select .
