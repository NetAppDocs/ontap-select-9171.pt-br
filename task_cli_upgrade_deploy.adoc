...
Para iniciar o processo de atualização, baixe o arquivo de atualização da máquina virtual ONTAP Select Deploy apropriado do seguinte local:link:https://mysupport.netapp.com/site/["Site de suporte da NetApp"^] . O pacote de atualização é formatado como um único arquivo compactado.

.Passos
. Acesse olink:https://mysupport.netapp.com/site/["Site de suporte da NetApp"^] Utilize um navegador da web e selecione *Downloads* no menu Downloads.
